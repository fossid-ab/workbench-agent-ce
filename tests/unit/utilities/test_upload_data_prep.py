...
@patch("workbench_agent.utilities.upload_data_prep.UploadArchivePrep._parse_gitignore")
...
class TestCleanupTempPath:
    ...
    def test_removes_temp_directory(self):
        ...
        with (
            ...
            mock_rmtree.assert_called_once_with("/tmp/workbench_upload_xyz", ignore_errors=True)
    ...
    def test_swallows_oserror(self):
        ...
        with (
            ...
            patch("workbench_agent.utilities.upload_data_prep.logger.warning") as mock_warning,
        ):
...
class TestPreparedScanTarget:
    ...
    def test_file_input_yielded_unchanged(self):
        ...
        with (
            ...
            patch.object(UploadArchivePrep, "create_zip_archive") as mock_create,
            patch("workbench_agent.utilities.upload_data_prep.cleanup_temp_path") as mock_cleanup,
        ):
