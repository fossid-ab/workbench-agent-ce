...
class TestGetProjectPolicyLive:
    def test_get_project_policy_returns_json_array(self, workbench_client, test_project_code):
        policy = workbench_client.policy.download_project_policy_json(test_project_code)
